        ...
        ***********************************-->
        <div class="nav-header">
           <!-- <a href="index.html" class="brand-logo">
            ...
            <h4 class="text-white p-4">Auto Gear</h4>
        </div>
        <!--**********************************
            Nav header end
        ***********************************-->
        ...
        ***********************************-->
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div align="right">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Add New Product</button>
				</div>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
                    ...
                    <textarea type="text" name="product_desc" id="product_desc" class="form-control" placeholder="Enter Product Description" ></textarea>
                    <br />
                    <label>Keywords</label>
					<input type="text" name="product_keywords" id="product_keywords" class="form-control" placeholder="Enter Keyword" />
                    <br />
        ...
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Product Description</label>
                  <textarea class="form-control" name="e_product_desc" placeholder="Product description"></textarea>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
            ...
            <div class="col-12" style="float:right">
              ...
              <button type="button" class="btn btn-success submit-edit-product">Add Product</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
              <br><br>
          </div>
                           ...
                           if (productList) {
                               $.each(resp.message.products, function(index, value){
                                   ...
                                   productHTML += '<tr>'+
                                                   ...
                                                   '<td>'+ value.pro_user_add_id +'</td>'+
                                                   '<td>'+ value.product_desc +'</td>'+
                                                     '<td><a class="btn btn-sm btn-info edit-product" style="color:#fff;"><span style="display:none;">'+JSON.stringify(value)+'</span><i class=" glyphicon glyphicon-pencil">UPDATE</i></a>&nbsp;<a pid="'+value.product_id+'" class="btn btn-sm btn-danger delete-product" style="color:#fff;"><i class=" glyphicon glyphicon-trash">DELETE</i></a></td>'+
                                                   '</tr>';
