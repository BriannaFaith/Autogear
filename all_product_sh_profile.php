                                ...
                                <figure>
                                    ...
                                    <div class="product_content">
                                        <div class="product_content_inner">
                                            ...
                                            <h4 class="product_name"><a href="product_details_v_profile.php?idp01=<?php echo $pro_id;?>"><?php echo $pro_title; ?></a></h4>
                                            ...
                                            <div class="price_box"> 
                                                <span class="old_price">Kshs <?php echo $per; ?></span> 
                                                <span class="current_price">Kshs <?php echo $pro_price; ?></span>
                                            </div>
                                        </div> 
